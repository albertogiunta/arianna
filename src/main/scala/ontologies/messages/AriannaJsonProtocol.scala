...
object AriannaJsonProtocol extends DefaultJsonProtocol {
    ...
    implicit val singleThreshold: RootJsonFormat[ThresholdInfo] = jsonFormat1(SingleThresholdInfo)
    implicit val doubleThreshold: RootJsonFormat[ThresholdInfo] = jsonFormat2(DoubleThresholdInfo)
