...
object AriannaJsonProtocol extends DefaultJsonProtocol {
    ...
    implicit val sensorListFormat: RootJsonFormat[SensorsUpdate] = jsonFormat2(SensorsUpdate.apply)
    ...
    implicit val cellForCellFormat: RootJsonFormat[CellViewedFromACell] = jsonFormat7(CellViewedFromACell.apply)
    implicit val areaForCellFormat: RootJsonFormat[AreaViewedFromACell] = jsonFormat2(AreaViewedFromACell.apply)
    ...
    implicit val actualLoadUpdateFormat: RootJsonFormat[CurrentPeopleUpdate] = jsonFormat2(CurrentPeopleUpdate.apply)
